...
def _load_weights(model: VisionTransformer, checkpoint_path: str, prefix: str = "") -> None:
    ...
    for i, block in enumerate(model.blocks.children()):
        ...
        block.attn.qkv.weight.copy_(
            torch.cat([_n2p(w[f"{mha_prefix}{n}/kernel"], t=False, idx=idx).flatten(1).T for n in ("query", "key", "value")])
        )
        block.attn.qkv.bias.copy_(
            torch.cat([_n2p(w[f"{mha_prefix}{n}/bias"], t=False, idx=idx).reshape(-1) for n in ("query", "key", "value")])
        )
...
default_cfgs = {
    ...
    "vit_medium_patch16_gap_240.sw_in12k": _cfg(hf_hub_id="timm/", input_size=(3, 240, 240), crop_pct=0.95, num_classes=11821),
    ...
    "vit_base_patch32_clip_224.laion2b_ft_in12k_in1k": _cfg(hf_hub_id="timm/", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD),
    ...
    "vit_huge_patch14_clip_336.laion2b_ft_in1k": _cfg(
        hf_hub_id="", mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, crop_pct=1.0, input_size=(3, 336, 336), crop_mode="squash"
    ),
    ...
    "vit_large_patch14_clip_336.openai": _cfg(
        hf_hub_id="timm/vit_large_patch14_clip_336.openai",
        hf_hub_filename="open_clip_pytorch_model.bin",
        notes=("natively QuickGELU, use quickgelu model variant for original results",),
        mean=OPENAI_CLIP_MEAN,
        std=OPENAI_CLIP_STD,
    ...
    "vit_base_patch16_siglip_224.webli": _cfg(
        hf_hub_id="timm/ViT-B-16-SigLIP", hf_hub_filename="open_clip_pytorch_model.bin", num_classes=0
    ),
    ...
    "vit_so400m_patch14_siglip_224.webli": _cfg(
        hf_hub_id="timm/ViT-SO400M-14-SigLIP", hf_hub_filename="open_clip_pytorch_model.bin", num_classes=0
    ),
    ...
    "vit_so400m_patch14_siglip_gap_224.pali_mix": _cfg(
        hf_hub_id="google/paligemma-3b-mix-224-jax", hf_hub_filename="paligemma-3b-mix-224.npz", custom_load="hf", num_classes=0
    ),
    "vit_so400m_patch14_siglip_gap_224.pali_pt": _cfg(
        hf_hub_id="google/paligemma-3b-pt-224-jax", hf_hub_filename="paligemma-3b-pt-224.npz", custom_load="hf", num_classes=0
    ),
    ...
    "vit_medium_patch16_reg4_gap_256.sbb_in12k_ft_in1k": _cfg(hf_hub_id="timm/", input_size=(3, 256, 256), crop_pct=0.95),
    ...
    "test_vit.r160_in1k": _cfg(hf_hub_id="timm/", input_size=(3, 160, 160), crop_pct=0.875),
}
...
default_cfgs.update({n.replace("_clip_", "_clip_quickgelu_"): default_cfgs[n] for n in _quick_gelu_cfgs})
...
def vit_xsmall_patch16_clip_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_xsmall_patch16_clip_224", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_medium_patch32_clip_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    # TinyCLIP 40M
    model_args = dict(patch_size=32, embed_dim=512, depth=12, num_heads=8, pre_norm=True, norm_layer=nn.LayerNorm)
    model = _create_vision_transformer("vit_medium_patch32_clip_224", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_medium_patch16_clip_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_medium_patch16_clip_224", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_betwixt_patch32_clip_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    # TinyCLIP 61M
    model_args = dict(patch_size=32, embed_dim=640, depth=12, num_heads=10, pre_norm=True, norm_layer=nn.LayerNorm)
    model = _create_vision_transformer("vit_betwixt_patch32_clip_224", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_base_patch32_clip_quickgelu_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    """ViT-B/32 CLIP image tower @ 224x224"""
    model_args = dict(
        patch_size=32, embed_dim=768, depth=12, num_heads=12, pre_norm=True, norm_layer=nn.LayerNorm, act_layer="quick_gelu"
    )
...
def vit_base_patch16_clip_quickgelu_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model_args = dict(
        patch_size=16, embed_dim=768, depth=12, num_heads=12, pre_norm=True, norm_layer=nn.LayerNorm, act_layer="quick_gelu"
    )
    model = _create_vision_transformer(
...
def vit_large_patch14_clip_quickgelu_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model_args = dict(
        patch_size=14, embed_dim=1024, depth=24, num_heads=16, pre_norm=True, norm_layer=nn.LayerNorm, act_layer="quick_gelu"
    )
    model = _create_vision_transformer(
...
def vit_huge_patch14_clip_quickgelu_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model_args = dict(
        patch_size=14, embed_dim=1280, depth=32, num_heads=16, pre_norm=True, norm_layer=nn.LayerNorm, act_layer="quick_gelu"
    )
    model = _create_vision_transformer(
...
def vit_small_patch16_18x2_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    Paper focuses on 24x2 + 48x1 for 'Small' width but those are extremely slow.
    """
    model_args = dict(patch_size=16, embed_dim=384, depth=18, num_heads=6, init_values=1e-5, block_fn=ParallelThingsBlock)
...
def vit_base_patch16_18x2_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    Based on `Three things everyone should know about Vision Transformers` - https://arxiv.org/abs/2203.09795
    """
    model_args = dict(patch_size=16, embed_dim=768, depth=18, num_heads=12, init_values=1e-5, block_fn=ParallelThingsBlock)
...
def vit_base_patch16_siglip_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_base_patch16_siglip_224", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_base_patch16_siglip_384(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_base_patch16_siglip_384", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_base_patch16_siglip_512(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_base_patch16_siglip_512", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_large_patch16_siglip_256(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_large_patch16_siglip_256", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_large_patch16_siglip_384(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_large_patch16_siglip_384", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_so400m_patch14_siglip_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_so400m_patch14_siglip_224", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_so400m_patch14_siglip_384(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_so400m_patch14_siglip_384", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_base_patch16_siglip_gap_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_base_patch16_siglip_gap_224", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_base_patch16_siglip_gap_256(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_base_patch16_siglip_gap_256", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_base_patch16_siglip_gap_384(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_base_patch16_siglip_gap_384", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_base_patch16_siglip_gap_512(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_base_patch16_siglip_gap_512", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_large_patch16_siglip_gap_256(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_large_patch16_siglip_gap_256", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_large_patch16_siglip_gap_384(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_large_patch16_siglip_gap_384", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_so400m_patch14_siglip_gap_224(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_so400m_patch14_siglip_gap_224", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_so400m_patch14_siglip_gap_384(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_so400m_patch14_siglip_gap_384", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_so400m_patch14_siglip_gap_448(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_so400m_patch14_siglip_gap_448", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_so400m_patch14_siglip_gap_896(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_so400m_patch14_siglip_gap_896", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_wee_patch16_reg1_gap_256(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_wee_patch16_reg1_gap_256", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_pwee_patch16_reg1_gap_256(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_pwee_patch16_reg1_gap_256", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_little_patch16_reg1_gap_256(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_little_patch16_reg1_gap_256", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_little_patch16_reg4_gap_256(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_little_patch16_reg4_gap_256", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_medium_patch16_reg1_gap_256(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_medium_patch16_reg1_gap_256", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_medium_patch16_reg4_gap_256(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_medium_patch16_reg4_gap_256", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_mediumd_patch16_reg4_gap_256(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_mediumd_patch16_reg4_gap_256", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_betwixt_patch16_reg1_gap_256(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_betwixt_patch16_reg1_gap_256", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_betwixt_patch16_reg4_gap_256(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_betwixt_patch16_reg4_gap_256", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_base_patch16_reg4_gap_256(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_base_patch16_reg4_gap_256", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_so150m_patch16_reg4_map_256(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_so150m_patch16_reg4_map_256", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_so150m_patch16_reg4_gap_256(pretrained: bool = False, **kwargs) -> VisionTransformer:
    ...
    model = _create_vision_transformer("vit_so150m_patch16_reg4_gap_256", pretrained=pretrained, **dict(model_args, **kwargs))
    return model
