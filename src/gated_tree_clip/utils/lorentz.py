...
def pairwise_dist(x: Tensor, y: Tensor, curv: float | Tensor = 1.0, eps: float = 1e-8) -> Tensor:
    """
...
def half_aperture(x: Tensor, curv: float | Tensor = 1.0, min_radius: float = 0.1, eps: float = 1e-8) -> Tensor:
    """
